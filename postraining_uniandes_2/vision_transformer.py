...
'''
Simplified only to mantain the vit_giant_xformers. Also deleted the masking functionality, as it is not used in the postraining.

The rest of the code is the same as in the original version
