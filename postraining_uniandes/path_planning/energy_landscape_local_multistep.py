...
plt.savefig(os.path.join(script_dir, "energy_landscape_original_v4_lemon.png"), bbox_inches='tight', dpi=150)
print(f"\nGround truth action frame 1→2: (x={gt_x:.4f}, y={gt_y:.4f}, z={gt_z:.4f})")
print(f"Saved energy landscape to {os.path.join(script_dir, 'energy_landscape_original_v4_lemon.png')}")
plt.close()
