...
parser.add_argument("--verbose", action="store_true", help="whether to print info during training")


def main_process(rank, fname, num_gpus, devices, verbose):
...
if __name__ == "__main__":
    ...
    for rank in range(num_gpus): #In case of multiple GPU usage. 
        mp.Process(target=main_process, args=(rank, args.fname, num_gpus, args.devices, args.verbose)).start()